    ...
    <div className="fixed top-12 right-4 z-20 font-jungle">
      ...
      <div className="relative">
        <div className="absolute -top-5 -left-18 z-30">
          <img
            src="./src/assets/icons/scroll.svg"
            alt="Scroll"
            className="w-20 h-18"
          />
        ...
        >
          <div className="absolute left-2 top-1/2 -translate-y-1/2 flex items-center -space-x-11">
            <div className="flex items-center">
              <img
                src="./src/assets/icons/wolfGem.svg"
                alt="wolf gem"
                className="w-25 h-25"
              />
            ...
            <div className="flex items-center">
              <img
                src="./src/assets/icons/bearGem.svg"
                alt="bear gem"
                className="w-34 h-34"
              />
            ...
            <div className="flex items-center">
              <img
                src="./src/assets/icons/bullGem.svg"
                alt="bull gem"
                className="w-27 h-27"
              />
        ...
        <div className="absolute right-2 top-1/2 -translate-y-1/2 z-40">
          <img
            src="./src/assets/icons/currentLevel.svg"
            alt="Current Level"
            className="w-28 h-28"
          />
        </div>
